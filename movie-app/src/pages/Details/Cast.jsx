  ...
  return (
    <div className="relative mb-[50px] ">
      <div className="mx-auto max-w-[1200px] w-full px-[20px] relative ">
        ...
        />
        <BsFillArrowRightCircleFill
          className="absolute top-[39%] text-black text-[30px] z-[1] right-[40px] cursor-pointer translate-y-[50%] opacity-[0.5] hover:opacity-[0.6] hidden min-[768px]:block fill-white"
          onClick={() => navigation("right")}
        />
        {!loading && (
          <div className="flex h-full gap-[20px] max-w-[1200px] w-full overflow-y-scroll mx-[-20px] px-[20px] min-[768px]:m-0 min-[768px]:p-0 " ref={castContainer}>
            {data?.map((actor) => {
              ...
              return (
                <div key={actor?.id} className="text-center text-white " >
                  <a href={`https://www.google.com/search?q=${actor.name} `} target="_blank">
